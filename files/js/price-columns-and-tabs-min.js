...
function TabTwoSetEqualHeightForListsThree(TabTwoClassNameThree) {
   ...
   for (var i = 0; i < TabTwoElementsThree.length; i++) {
      ...
      var TabTwoSecondItemsThree = TabTwoSecondListThree.querySelectorAll('.js-tab-two-si-three'); for (var j = 0; j < TabTwoFirstItemsThree.length && j < TabTwoSecondItemsThree.length; j++) { var TabTwoFirstHeightThree = TabTwoFirstItemsThree[j].clientHeight; var TabTwoSecondHeightThree = TabTwoSecondItemsThree[j].clientHeight; var TabTwoMaxHeightThree = Math.max(TabTwoFirstHeightThree, TabTwoSecondHeightThree); TabTwoFirstItemsThree[j].style.height = TabTwoMaxHeightThree + "px"; TabTwoSecondItemsThree[j].style.height = TabTwoMaxHeightThree + "px"; }
   }
} document.getElementById('tab-two-block-three').addEventListener("click", function () { setTimeout(() => { TabTwoSetEqualHeightForListsThree(".js-tab-two-columns-three"); }, 1) }); function TabThreeSetEqualHeightForListsOne(TabThreeClassNameOne) { var TabThreeElementsOne = document.querySelectorAll(TabThreeClassNameOne); for (var i = 0; i < TabThreeElementsOne.length; i++) { var TabThreeParentOne = TabThreeElementsOne[i].parentNode; var TabThreeFirstListOne = TabThreeParentOne.querySelector('.js-tab-three-fl-one'); var TabThreeSecondListOne = TabThreeParentOne.querySelector('.js-tab-three-sl-one'); var TabThreeFirstItemsOne = TabThreeFirstListOne.querySelectorAll('.js-tab-three-fi-one'); var TabThreeSecondItemsOne = TabThreeSecondListOne.querySelectorAll('.js-tab-three-si-one'); for (var j = 0; j < TabThreeFirstItemsOne.length && j < TabThreeSecondItemsOne.length; j++) { var TabThreeFirstHeightOne = TabThreeFirstItemsOne[j].clientHeight; var TabThreeSecondHeightOne = TabThreeSecondItemsOne[j].clientHeight; var TabThreeMaxHeightOne = Math.max(TabThreeFirstHeightOne, TabThreeSecondHeightOne); TabThreeFirstItemsOne[j].style.height = TabThreeMaxHeightOne + "px"; TabThreeSecondItemsOne[j].style.height = TabThreeMaxHeightOne + "px"; } } } document.getElementById('our-plans-three').addEventListener("click", function () { setTimeout(() => { TabThreeSetEqualHeightForListsOne(".js-tab-three-columns-one"); }, 1) }); document.getElementById('tab-three-block-one').addEventListener("click", function () { setTimeout(() => { TabThreeSetEqualHeightForListsOne(".js-tab-three-columns-one"); }, 1) });
function TabThreeSetEqualHeightForListsTwo(TabThreeClassNameTwo) {
   var TabThreeElementsTwo = document.querySelectorAll(TabThreeClassNameTwo); for (var i = 0; i < TabThreeElementsTwo.length; i++) { var TabThreeParentTwo = TabThreeElementsTwo[i].parentNode; var TabThreeFirstListTwo = TabThreeParentTwo.querySelector('.js-tab-three-fl-two'); var TabThreeSecondListTwo = TabThreeParentTwo.querySelector('.js-tab-three-sl-two'); var TabThreeFirstItemsTwo = TabThreeFirstListTwo.querySelectorAll('.js-tab-three-fi-two'); var TabThreeSecondItemsTwo = TabThreeSecondListTwo.querySelectorAll('.js-tab-three-si-two'); for (var j = 0; j < TabThreeFirstItemsTwo.length && j < TabThreeSecondItemsTwo.length; j++) { var TabThreeFirstHeightTwo = TabThreeFirstItemsTwo[j].clientHeight; var TabThreeSecondHeightTwo = TabThreeSecondItemsTwo[j].clientHeight; var TabThreeMaxHeightTwo = Math.max(TabThreeFirstHeightTwo, TabThreeSecondHeightTwo); TabThreeFirstItemsTwo[j].style.height = TabThreeMaxHeightTwo + "px"; TabThreeSecondItemsTwo[j].style.height = TabThreeMaxHeightTwo + "px"; } }
} document.getElementById('tab-three-block-two').addEventListener("click", function () { setTimeout(() => { TabThreeSetEqualHeightForListsTwo(".js-tab-three-columns-two"); }, 1) }); function TabThreeSetEqualHeightForListsThree(TabThreeClassNameThree) { var TabThreeElementsThree = document.querySelectorAll(TabThreeClassNameThree); for (var i = 0; i < TabThreeElementsThree.length; i++) { var TabThreeParentThree = TabThreeElementsThree[i].parentNode; var TabThreeFirstListThree = TabThreeParentThree.querySelector('.js-tab-three-fl-three'); var TabThreeSecondListThree = TabThreeParentThree.querySelector('.js-tab-three-sl-three'); var TabThreeFirstItemsThree = TabThreeFirstListThree.querySelectorAll('.js-tab-three-fi-three'); var TabThreeSecondItemsThree = TabThreeSecondListThree.querySelectorAll('.js-tab-three-si-three'); for (var j = 0; j < TabThreeFirstItemsThree.length && j < TabThreeSecondItemsThree.length; j++) { var TabThreeFirstHeightThree = TabThreeFirstItemsThree[j].clientHeight; var TabThreeSecondHeightThree = TabThreeSecondItemsThree[j].clientHeight; var TabThreeMaxHeightThree = Math.max(TabThreeFirstHeightThree, TabThreeSecondHeightThree); TabThreeFirstItemsThree[j].style.height = TabThreeMaxHeightThree + "px"; TabThreeSecondItemsThree[j].style.height = TabThreeMaxHeightThree + "px"; } } } document.getElementById('tab-three-block-three').addEventListener("click", function () { setTimeout(() => { TabThreeSetEqualHeightForListsThree(".js-tab-three-columns-three"); }, 1) });