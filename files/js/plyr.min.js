...
//const players_pause = document.querySelectorAll('.popup');
/*

document.querySelectorAll('.popup__body').forEach(function (link_o) {
   link_o.onclick = function () {
      player.pause();
   };
});
...
document.getElementById('work_pause').addEventListener('click', () => {
   player.pause();
});
...
/*
const player_pause = document.querySelectorAll('.popup__body');
